...
RegisterNUICallback("hireMedic", function(data, cb)
    TriggerServerEvent("Painel_Mecanica:server:hireMedic", data.passport)
    cb("ok")
end)

RegisterNUICallback("fireMedic", function(data, cb)
    TriggerServerEvent("Painel_Mecanica:server:fireMedic", data.passport)
    cb("ok")
end)

RegisterNUICallback("setMedicLevel", function(data, cb)
    TriggerServerEvent("Painel_Mecanica:server:setMedicLevel", data.passport, data.level)
    cb("ok")
end)
